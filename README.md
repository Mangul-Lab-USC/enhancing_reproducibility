...
When a commit to the `master` branch occurs (for example, when a pull request is merged), Travis CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/Mangul-Lab-USC/enhancing_reproducibility/tree/gh-pages) and [`output`](https://github.com/Mangul-Lab-USC/enhancing_reproducibility/tree/output) branches.
The `gh-pages` branch uses [GitHub Pages](https://pages.github.com/) to host the following URLs:

+ **HTML manuscript** at https://Mangul-Lab-USC.github.io/enhancing_reproducibility/
+ **PDF manuscript** at https://Mangul-Lab-USC.github.io/enhancing_reproducibility/manuscript.pdf
...
Please attribute by linking to https://github.com/Mangul-Lab-USC/enhancing_reproducibility.
...
Please open [an issue](https://github.com/Mangul-Lab-USC/enhancing_reproducibility/issues) for any question related to licensing.
